...
<@main>
						...
						<div class="col-xs-12 infobox-container">
								<div class="infobox infobox-green  ">
									...
									<div class="infobox-data">
										<span class="infobox-data-number">1132</span>
										<div class="infobox-content">设备总数</div>
									</div>
								...
								<div class="infobox infobox-blue  ">
									...
									<div class="infobox-data">
										...
										<div class="infobox-content">新产品</div>
									</div>
								...
								<div class="infobox infobox-pink  ">
									...
									<div class="infobox-data">
										...
										<div class="infobox-content">上线设备</div>
									</div>
								...
								<div class="infobox infobox-orange2  ">
									...
									<div class="infobox-data">
										...
										<div class="infobox-content">9小时内数据量</div>
									</div>
								...
								<div class="infobox infobox-blue2  ">
									<div class="infobox-progress">
										<div class="easy-pie-chart percentage" data-percent="99.9" data-size="46">
		...
		<i class="icon-double-angle-up icon-only bigger-110"></i>
			...
			jQuery(function($) {
			  ...
			  var data1 = [
				{ label: "电动车",  data: 38.7, color: "#68BC31"},
				{ label: "纺织机",  data: 24.5, color: "#2091CF"},
				{ label: "电梯",  data: 8.2, color: "#AF4E96"},
				{ label: "自动售卖机",  data: 18.6, color: "#DA5430"},
				{ label: "其他",  data: 10, color: "#FEE074"}
			  ]
			  var placeholder2 = $('#piechart-placeholder2').css({'width':'90%' , 'min-height':'150px'});
			  var data2 = [
				{ label: "2G",  data: 60, color: "#68BC31"},
				{ label: "3G",  data: 14.5, color: "#2091CF"},
				{ label: "4G",  data: 0.5, color: "#AF4E96"},
				{ label: "nb",  data: 20, color: "#DA5430"},
				{ label: "wifi",  data: 5, color: "#FEE074"}
			  ]
			  var placeholder3 = $('#piechart-placeholder3').css({'width':'90%' , 'min-height':'150px'});
			  var data3 = [
				{ label: "电瓶车商",  data: 25, color: "#68BC31"},
				{ label: "纺织机商",  data: 45, color: "#2091CF"},
				{ label: "电梯商",  data: 8.2, color: "#AF4E96"},
				{ label: "自动售卖机商",  data: 18.5, color: "#DA5430"},
				{ label: "其他",  data: 3.3, color: "#FEE074"}
			  ]
			 ...
			 placeholder2.data('chart', data1);
			 placeholder2.data('draw', drawPieChart);
			 placeholder3.data('chart', data1);

    ...
    <form class="form-horizontal" action="" method="post">
       ...
       <div class="form-group">
		...
		<div class="form-group">
			...
			<a  href="${web_base}/business/product_msg_map!list.htm?productInfo.productKey=${entity.productKey}&productInfo.productName=${entity.productName!}" target="_blank">
				前往新增<i class="icon-arrow-right  bigger-125"></i>
			</a>
			</div>
		</div>
			<#if pmml??>
